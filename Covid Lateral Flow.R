...
# We use R Library "SIMMER" for Simulation
# R Simmer Reference - https://r-simmer.org/reference/index.html
# link of reference- https://youtu.be/Qe1NvHJcmZs
...
# R Simmer Simulation Steps:
#    Define Process Trajectory (Path)
#    Define Resources - People, Machines, Facilities
#    Define Arrivals -  Entities, Work Items, People, etc
#    Run The Simulation
...
# COVID-19 Lateral Flow Testing Process & Layout
browseURL("https://pasteboard.co/JWYtAbs.png")
